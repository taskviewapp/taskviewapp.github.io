...
> App Store and Google Play listings coming soon. Join the waitlist by submitting a feature request in the app.
...
**Brain Dump**
A rapid-capture scratchpad for thoughts, ideas, and anything your brain needs to offload. Each entry is timestamped. Pages roll over at midnight. Everything is searchable.

**Search**
Live full-text search across every screen — tasks, notes, and Brain Dump pages. Tap any Brain Dump result to see the full page in context.

**Inbox**
Uncompleted tasks from previous days surface here automatically. Mark them done or move them to a future date without losing the original record.
...
**Settings**
Personalize your greeting, week start day, and date format. Built-in feature request form sends feedback directly to the team.
